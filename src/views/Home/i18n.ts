...
i18next.addResources(LOCALES.ES, 'HOME', {
  ...
  RULES: [
    ...
    'Si aciertas los equipos que pasan la zona de grupos ganas 10 puntos por cada uno.',
    ...
    'Si aciertas al goleador del campeonato mundial ganas 20 puntos. Si hay empate igual se ganan todos los puntos.',
    'Del total de dinero recogido el 85% será para el ganador, 10% para el segundo lugar y 5% para el tercer lugar. Si hay empate el monto se repartirá entre los involucrados.',
    'Antes de empezar el Campeonato Mundial se hará entrega de un listado de todos los participantes con sus pronosticos.',
  ],
