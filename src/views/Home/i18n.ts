...
i18next.addResources(LOCALES.ES, 'HOME', {
  ...
  RULES: [
    ...
    'Para pagos en USD a través de zelle: carsco13@gmail.com. Para pagos en Bs (al cambio paralelo) a través de pago móvil: 04166460249, CI 9234795, Banesco. Notificar el pago enviando un comprobante al correo carsco13@gmail.com indicando los participantes que están pagando. Realizar el pago antes del inicio del Mundial.',
  ],
