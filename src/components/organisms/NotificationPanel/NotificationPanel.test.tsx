...
describe('NotificationPanel', () => {
  ...
  it('calls onMarkAsRead when notification clicked', async () => {
    ...
    render(<NotificationPanel notifications={mockNotifications} onMarkAsRead={handleMarkAsRead} />);
  ...
  it('calls onClearAll when clear button clicked', async () => {
    ...
    render(<NotificationPanel notifications={mockNotifications} onClearAll={handleClearAll} />);
